...
const columns = [
    { headerName: "SId", field: "SId", flex: 1 },
    { headerName: "Name", field: "Name", flex: 1 },
    { headerName: "Industry", field: "Industry", flex: 1 },
    { headerName: "FoundingDate", field: "FoundingDate", flex: 1 },
    { headerName: "FundingReceived", field: "FundingReceived", flex: 1 },
...
const Component = (props) => {
    ...
    const FetchResults = async () => {
        ...
        await Api.GetStartupsMulti(query, "")
            .then(async (res) => {
                if (res.status) {
                    _rows = res.values || [];
                    if (_rows.length > 0) {
    ...
    return (
        ...
        <>
            <Container {...props}>
                ...
                <Box style={{ width: '100%' }}>
                    <DataTable keyId={'SId'} columns={columns} rowsCount={rowsCount} rows={rows} sortBy={sortBy} pageInfo={pageInfo} onActionClicked={OnActionClicked}
